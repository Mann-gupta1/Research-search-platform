...
![Landing page showing five recent documents, filters, and analytics sidebar](docs/screenshots/browse-recent-documents.png)

### Semantic search

Natural-language search returns ranked results with match scores, metadata (date, citations, tags), and clustered sub-topics.

![Semantic search for “Machine learning” with result cards and sub-topic clusters](docs/screenshots/semantic-search-results.png)
